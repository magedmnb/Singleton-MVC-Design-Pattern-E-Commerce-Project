        ...
        <input type="hidden" value="<?php echo $cursub['cat_id'] ?>" name="sub_id"/>
									<div class="alert alert-danger display-hide">
										<button class="close" data-close="alert"></button>
											...
											<select style="color: blue;" class="form-control" name="cat" id="list-select">
											 ...
											 <?php
						                          foreach( $category as $cat){
						                              if($cat->cat_id == $parent['cat_id'])
                                                      {
           	echo'<option style="color:red" name="cat"  id="cat_id" value="'.$cat->cat_id.'" selected>'.$cat->cat_name.'</option>';
                                                      }else
                                                      {
	                                            	echo'<option style="color:red" name="cat"  id="cat_id" value="'.$cat->cat_id.'">'.$cat->cat_name.'</option>';
						                              }
                                                      }
                                                   ?>
											</select>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" value="<?php echo $cursub['cat_name'];?>" name="sub" data-required="1" class="form-control" required/>
										</div>
									</div>
