...
class IndexController extends AbstractController
{
    ...
    public function index()
        {
            if(Product::showAllAuthors() !== false)
             {
                $this->results = Product::showAllAuthors();
                $this->template->products=$this->results; 
            }
              if(Product::showAllSale() !== false)
             {
                $this->mnb = Product::showAllSale();
                $this->template->saleproducts=$this->mnb; 
            }
         ...
         public function shop_item()
        {
            ...
            $this->controller="shop_item";
               if(Category::selectCategoryById($product_id) !== false) 
                  {
                    $this->results = Category::selectCategoryById($product_id);
