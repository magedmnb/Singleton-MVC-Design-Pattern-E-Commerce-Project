    ...
    <div class="page-slider margin-bottom-35">
      <!-- LayerSlider start -->
      <div id="layerslider" style="width: 100%; height: 490px; margin: 0 auto;">
        ...
        <div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 24,25,27,28;">
          ...
          <div class="ls-l ls-title" style="top: 96px; left: 35%; white-space: nowrap;" data-ls="
            ...
            scaleout: .5; 
            showuntil: 4000;
          ">Welcome <strong>Mansoura  Shop </strong> </div>

          <div class="ls-l ls-mini-text" style="top: 268px; left: 35%; white-space: nowrap;" data-ls="
          fade: true; 
          fadeout: true; 
          durationout: 750; 
          easingin: easeOutQuint; 
